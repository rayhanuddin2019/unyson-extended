...
class ATTR_Option_Type_Icon extends ATTR_Option_Type
{
	/**
	...
	{
		wp_enqueue_style(
			'attr-option-type-'. $this->get_type() .'-backend',
			attr_get_framework_directory_uri('/includes/option-types/'. $this->get_type() .'/static/css/backend.css'),
			attr()->manifest->get_version()
		);

		wp_enqueue_script(
			'attr-option-type-'. $this->get_type() .'-backend',
			attr_get_framework_directory_uri('/includes/option-types/'. $this->get_type() .'/static/js/backend.js'),
		...
		if (isset($sets[ $option['set'] ])) {
			...
			foreach($font_style_sources as $key => $style_source) {
				...
				if (!isset($this->enqueued_font_styles[ $style_hash ])) {
					wp_enqueue_style(
						"attr-option-type-{$this->get_type()}-font-{$option['set']}-{$style_hash}",
						$style_source,
						array(),
						attr()->manifest->get_version()
					);
	...
	protected function _render($id, $option, $data)
	{
		...
		return attr_render_view(dirname(__FILE__) . '/view.php', compact('id', 'option', 'data', 'set'));
	}
	...
	private function get_default_sets()
	{
		...
		//     groups => array(
		//         array(
		//             'title' => __('Web Application Icons', 'attr')
		//             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
		//         ),
		//         array(
		//             'title' => __('Transportation Icons', 'attr'),
		//             'icons' => array(...),
		//         ),
		//     )
		//
		...
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				'font-style-src' => attr_get_framework_directory_uri('/static/libs/font-awesome/css/font-awesome.min.css'),
				'container-class' => 'fa-lg', // some fonts need special wrapper class to display properly
				'groups' => array (
					'web-application' => __('Web Application Icons', 'attr'),
					//'accessibility' => __('Accessibility Icons', 'attr'),
					'hand' => __('Hand Icons', 'attr'),
					'transportation' => __('Transportation Icons', 'attr'),
					'gender' => __('Gender Icons', 'attr'),
					'file-type' => __('File Type Icons', 'attr'),
					//'spinner' => __('Spinner Icons', 'attr'),
					//'form-control' => __('Form Control Icons', 'attr'),
					'payment' => __('Payment Icons', 'attr'),
					//'chart' => __('Chart Icons', 'attr'),
					'currency' => __('Currency Icons', 'attr'),
					'text-editor' => __('Text Editor Icons', 'attr'),
					'directional' => __('Directional Icons', 'attr'),
					'video-player' => __('Video Player Icons', 'attr'),
					'brand' => __('Brand Icons', 'attr'),
					'medical' => __('Medical Icons', 'attr'),
				),
				'icons' => array(
