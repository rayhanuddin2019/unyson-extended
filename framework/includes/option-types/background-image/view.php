...
<div <?php echo attr_attr_to_html($wrapper_attr) ?>>
	<div class="type">
		<?php
		echo attr()->backend->option_type( 'radio' )->render(
			'type',
			array(
				'type'    => 'radio',
				'value'   => 'predefined',
				'choices' => array(
					'predefined' => __( 'Predefined images', 'attr' ),
					'custom'     => __( 'Custom image', 'attr' )
				),
			),
			array(
	...
	<div class="predefined" <?php if ($data['value']['type'] === 'custom'): ?>style="display: none;"<?php endif; ?>>
		<?php
		echo attr()->backend->option_type( 'image-picker' )->render(
			'predefined',
			array(
				'type'    => 'image-picker',
				'value'   => $option['value'],
	...
	<div class="custom" <?php if ($data['value']['type'] !== 'custom'): ?>style="display: none;"<?php endif; ?>>
		<?php
		echo attr()->backend->option_type( 'upload' )->render(
			'custom',
			array(
				'type'  => 'upload'
			),
