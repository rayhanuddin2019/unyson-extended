...
abstract class ATTR_Type_Register {
	...
	public function register(ATTR_Type $type) {
	 ...
	 * @internal
	 */
	public function _get_types(ATTR_Access_Key $access_key) {
	 ...
	 * @since 2.5.12
	 */
	public function _get_type(ATTR_Access_Key $access_key, $type) {
		if (!isset($this->access_keys[$access_key->get_key()])) {
			trigger_error('Method call denied', E_USER_ERROR);
		}
