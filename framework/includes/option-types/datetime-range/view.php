...
<div <?php echo attr_attr_to_html($wrapper_attr) ?> >
	...
	<?php echo attr()->backend->option_type( 'datetime-picker' )->render( 'from', array(
	...
	<div class="delimiter"><?php echo __('to', 'attr') ?></div>

	<?php echo attr()->backend->option_type( 'datetime-picker' )->render( 'to', array(
		'type'  => 'datetime-picker',
