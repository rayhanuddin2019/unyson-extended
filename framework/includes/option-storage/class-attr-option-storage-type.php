...
abstract class ATTR_Option_Storage_Type extends ATTR_Type {
	/**
	 ...
	 *
	 *    <?php
	 *    return return attr()->backend->option_type($option['type'])->get_value_from_input(array('type' => $option['type']), null);
	 */
