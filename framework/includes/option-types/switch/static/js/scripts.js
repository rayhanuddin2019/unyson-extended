jQuery(document).ready(function ($) {
	var optionTypeClass = 'attr-option-type-switch',
		customEventPrefix = 'attr:option-type:switch:';

	attrEvents.on('attr:options:init', function (data) {
		data.$elements.find('.'+ optionTypeClass +':not(.attr-option-initialized)')
