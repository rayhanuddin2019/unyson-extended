...
/**
 * Attr option type that allows to group option in a popup window
 *
 * Class ATTR_Option_Type_Popup
 */
class ATTR_Option_Type_Popup extends ATTR_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return attr_render_view( attr_get_framework_directory( '/includes/option-types/' . $this->get_type() . '/views/view.php' ),
	...
	protected function _get_value_from_input( $option, $input_value ) {
		 ...
		 * because popup <input> contains options db values got from attr.OptionsModal
		 * which can't be used as $input_value in second parameter of attr_get_options_values_from_input()
		 */
		$popup_options = array();
		foreach (attr_extract_only_options($option['popup-options']) as $popup_option_id => $popup_option) {
		...
		return attr_get_options_values_from_input($popup_options, array());
	}
