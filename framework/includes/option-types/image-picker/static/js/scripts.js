(function(){
	var optionTypeClass = 'attr-option-type-image-picker';
	var eventNamePrefix = 'attr:option-type:image-picker:';

	attr.options.register('image-picker', {
			...
			$elements.find('select')
				.imagepicker({
					...
					changed: function (oldValues, newValues) {
						...
						attr.options.trigger.changeForEl($this[0], {
							value: newValues[0]
						});
