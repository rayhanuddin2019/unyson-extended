 ...
 * 
 * For e.g. Inside some class is created an instance of ATTR_Access_Key with unique key 'whatever',
 ...
 * sets an requirement that some parameter should be an instance on ATTR_Access_Key and its key should be 'whatever'
 * 
 * function my_function(ATTR_Access_Key $key, $another_parameter) {
