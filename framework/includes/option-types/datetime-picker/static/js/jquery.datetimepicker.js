...
! function () {
	...
	o = 864e5, i = 3600, e = function ( e, t ) {
		...
		constructor: attrDateFormatter, getMonth: function ( e ) {
			var t, a = this;
			return 0 === (
...
var datetimepickerFactory = function ( e ) {
	...
	var a = {
		...
		inverseButton: ! 1,
		hours12: ! 1,
		next: "attr_xdsoft_next",
		prev: "attr_xdsoft_prev",
		dayOfWeekStart: 0,
		parentID: "body",
		...
		"function" == typeof attrDateFormatter && (
			r = n = new attrDateFormatter( {dateSettings: e.extend( {}, i, s )} )
		)
	}, u = {
		moment: {
	...
	e.extend( e.attrDatetimepicker, d ), s(), window.getComputedStyle || (
	...
	}, e.fn.attr_xdsoftScroller = function ( t, a ) {
		return this.each( function () {
			...
			"hide" !== a ? (
				e( this ).hasClass( "attr_xdsoft_scroller_box" ) || (
					r = u.children().eq( 0 ), n = u[0].clientHeight, o = r[0].offsetHeight, i = e( '<div class="attr_xdsoft_scrollbar"></div>' ), s = e( '<div class="attr_xdsoft_scroller"></div>' ), i.append( s ), u.addClass( "attr_xdsoft_scroller_box" ).append( i ), D = function ( e ) {
						var t = d( e ).y - c + p;
						t < 0 && (
							t = 0
						), t + s[0].offsetHeight > h && (
							t = h - s[0].offsetHeight
						), u.trigger( "scroll_element.attr_xdsoft_scroller", [l ? t / l : 0] )
					}, s.on( "touchstart.attr_xdsoft_scroller mousedown.attr_xdsoft_scroller", function ( r ) {
						n || u.trigger( "resize_scroll.attr_xdsoft_scroller", [a] ), c = d( r ).y, p = parseInt( s.css( "margin-top" ), 10 ), h = i[0].offsetHeight, "mousedown" === r.type || "touchstart" === r.type ? (
							t.ownerDocument && e( t.ownerDocument.body ).addClass( "attr_xdsoft_noselect" ), e( [
								t.ownerDocument.body,
								t.contentWindow
							] ).on( "touchend mouseup.attr_xdsoft_scroller", function a() {
								e( [
									t.ownerDocument.body,
									t.contentWindow
								] ).off( "touchend mouseup.attr_xdsoft_scroller", a ).off( "mousemove.attr_xdsoft_scroller", D ).removeClass( "attr_xdsoft_noselect" )
							} ), e( t.ownerDocument.body ).on( "mousemove.attr_xdsoft_scroller", D )
						) : (
						...
						g = ! 1, p = 0
					} ), u.on( "scroll_element.attr_xdsoft_scroller", function ( e, t ) {
						n || u.trigger( "resize_scroll.attr_xdsoft_scroller", [
							t,
							! 0
					...
					} ).on( "resize_scroll.attr_xdsoft_scroller", function ( e, t, a ) {
						var d, f;
						n = u[0].clientHeight, o = r[0].offsetHeight, f = (
							                                                  d = n / o
						                                                  ) * i[0].offsetHeight, d > 1 ? s.hide() : (
							s.show(), s.css( "height", parseInt( f > 10 ? f : 10, 10 ) ), l = i[0].offsetHeight - s[0].offsetHeight, ! 0 !== a && u.trigger( "scroll_element.attr_xdsoft_scroller", [
						...
						return (
							       ...
							       t = 0
						       ), u.trigger( "scroll_element.attr_xdsoft_scroller", [
							t / (
								o - n
							)
						] ), e.stopPropagation(), ! 1
				...
				), u.trigger( "resize_scroll.attr_xdsoft_scroller", [a] )
			) : u.find( ".attr_xdsoft_scrollbar" ).hide()
		} )
	}, e.fn.attrDatetimepicker = function ( n, i ) {
		var s, u, d = this, l = 48, f = 57, c = 96, m = 105, h = 17, g = 46, p = 13, D = 27, v = 8, y = 37, b = 38,
			...
			Y = function ( e ) {
				e.on( "open.attr_xdsoft focusin.attr_xdsoft mousedown.attr_xdsoft touchstart", function t() {
					e.is( ":disabled" ) || e.data( "attr_xdsoft_datetimepicker" ) || (
						clearTimeout( P ), P = setTimeout( function () {
							e.data( "attr_xdsoft_datetimepicker" ) || s( e ), e.off( "open.attr_xdsoft focusin.attr_xdsoft mousedown.attr_xdsoft touchstart", t ).trigger( "open.attr_xdsoft" )
						}, 100 )
					)
				} )
			};
		return s = function ( a ) {
			...
			function s( t ) {
				...
				t.mask && a.off( "keydown.attr_xdsoft" ), ! 0 === t.mask && (
					...
					n( t.mask, a.val() ) || (
					...
					), a.on( "paste.attr_xdsoft", function ( r ) {
						var i = (
						...
						) : "" === e.trim( s ) ? this.value = t.mask.replace( /[0-9]/g, "_" ) : a.trigger( "error_input.attr_xdsoft" ), r.preventDefault(), ! 1
					} ), a.on( "keydown.attr_xdsoft", function ( r ) {
						...
						if ( u >= l && u <= f || u >= c && u <= m || u === v || u === g ) {
							...
							) : "" === e.trim( s ) ? this.value = t.mask.replace( /[0-9]/g, "_" ) : a.trigger( "error_input.attr_xdsoft" )
			...
			var u, d, P, Y, A, H, j = e( '<div class="attr_xdsoft_datetimepicker attr_xdsoft_noselect"></div>' ),
				J = e( '<div class="attr_xdsoft_copyright"><a target="_blank" href="http://attr_xdsoft.net/jqplugins/datetimepicker/">attr_xdsoft.net</a></div>' ),
				z = e( '<div class="attr_xdsoft_datepicker active"></div>' ),
				I = e( '<div class="attr_xdsoft_monthpicker"><button type="button" class="attr_xdsoft_prev"></button><button type="button" class="attr_xdsoft_today_button"></button><div class="attr_xdsoft_label attr_xdsoft_month"><span></span><i></i></div><div class="attr_xdsoft_label attr_xdsoft_year"><span></span><i></i></div><button type="button" class="attr_xdsoft_next"></button></div>' ),
				N = e( '<div class="attr_xdsoft_calendar"></div>' ),
				L = e( '<div class="attr_xdsoft_timepicker active"><button type="button" class="attr_xdsoft_prev"></button><div class="attr_xdsoft_time_box"></div><button type="button" class="attr_xdsoft_next"></button></div>' ),
				E = L.find( ".attr_xdsoft_time_box" ).eq( 0 ), R = e( '<div class="attr_xdsoft_time_variant"></div>' ),
				V = e( '<button type="button" class="attr_xdsoft_save_selected blue-gradient-button">Save Selected</button>' ),
				B = e( '<div class="attr_xdsoft_select attr_xdsoft_monthselect"><div></div></div>' ),
				G = e( '<div class="attr_xdsoft_select attr_xdsoft_yearselect"><div></div></div>' ), U = ! 1, q = 0;
			C.id && j.attr( "id", C.id ), C.style && j.attr( "style", C.style ), C.weeks && j.addClass( "attr_xdsoft_showweeks" ), C.rtl && j.addClass( "attr_xdsoft_rtl" ), j.addClass( "attr_xdsoft_" + C.theme ), j.addClass( C.className ), I.find( ".attr_xdsoft_month span" ).after( B ), I.find( ".attr_xdsoft_year span" ).after( G ), I.find( ".attr_xdsoft_month,.attr_xdsoft_year" ).on( "touchstart mousedown.attr_xdsoft", function ( t ) {
				var a, r, n = e( this ).find( ".attr_xdsoft_select" ).eq( 0 ), o = 0, i = 0, s = n.is( ":visible" );
				for (
					I.find( ".attr_xdsoft_select" ).hide(), A.currentTime && (
						o = A.currentTime[e( this ).hasClass( "attr_xdsoft_month" ) ? "getMonth" : "getFullYear"]()
					), n[s ? "hide" : "show"](), a = n.find( "div.attr_xdsoft_option" ), r = 0; r < a.length && a.eq( r ).data( "value" ) !== o; r += 1
				) {
					i += a[0].offsetHeight;
				}
				return n.attr_xdsoftScroller( C, i / (
			...
			I.find( ".attr_xdsoft_select" ).attr_xdsoftScroller( C ).on( "touchstart mousedown.attr_xdsoft", function ( e ) {
				var t = e.originalEvent;
				this.touchMoved = ! 1, this.touchStartPosition = t.touches ? t.touches[0] : t, e.stopPropagation(), e.preventDefault()
			} ).on( "touchmove", ".attr_xdsoft_option", X ).on( "touchend mousedown.attr_xdsoft", ".attr_xdsoft_option", function () {
				if ( ! this.touchMoved ) {
					void 0 !== A.currentTime && null !== A.currentTime || (
						A.currentTime = A.now()
					);
					var t = A.currentTime.getFullYear();
					A && A.currentTime && A.currentTime[e( this ).parent().parent().hasClass( "attr_xdsoft_monthselect" ) ? "setMonth" : "setFullYear"]( e( this ).data( "value" ) ), e( this ).parent().parent().hide(), j.trigger( "xchange.attr_xdsoft" ), C.onChangeMonth && e.isFunction( C.onChangeMonth ) && C.onChangeMonth.call( j, A.currentTime, j.data( "input" ) ), t !== A.currentTime.getFullYear() && e.isFunction( C.onChangeYear ) && C.onChangeYear.call( j, A.currentTime, j.data( "input" ) )
				}
			} ), j.getValue = function () {
				...
				), ! C.open && ! C.opened || C.inline || a.trigger( "open.attr_xdsoft" ), C.inline && (
					U = ! 0, j.addClass( "attr_xdsoft_inline" ), a.after( j ).hide()
				), C.inverseButton && (
					C.next = "attr_xdsoft_prev", C.prev = "attr_xdsoft_next"
				...
				), isNaN( C.dayOfWeekStart ) ? C.dayOfWeekStart = 0 : C.dayOfWeekStart = parseInt( C.dayOfWeekStart, 10 ) % 7, C.timepickerScrollbar || E.attr_xdsoftScroller( C, "hide" ), C.minDate && /^[\+\-](.*)$/.test( C.minDate ) && (
				...
				), V.toggle( C.showApplyButton ), I.find( ".attr_xdsoft_today_button" ).css( "visibility", C.todayButton ? "visible" : "hidden" ), I.find( "." + C.prev ).css( "visibility", C.prevButton ? "visible" : "hidden" ), I.find( "." + C.next ).css( "visibility", C.nextButton ? "visible" : "hidden" ), s( C ), C.validateOnBlur && a.off( "blur.attr_xdsoft" ).on( "blur.attr_xdsoft", function () {
					if ( C.allowBlank && (
						! e.trim( e( this ).val() ).length || "string" == typeof C.mask && e.trim( e( this ).val() ) === C.mask.replace( /[0-9]/g, "_" )
					) ) {
						e( this ).val( null ), j.data( "attr_xdsoft_datetime" ).empty();
					} else {
						...
						j.data( "attr_xdsoft_datetime" ).setCurrentTime( e( this ).val() )
					}
					j.trigger( "changedatetime.attr_xdsoft" ), j.trigger( "close.attr_xdsoft" )
				} ), C.dayOfWeekStartPrev = 0 === C.dayOfWeekStart ? 6 : C.dayOfWeekStart - 1, j.trigger( "xchange.attr_xdsoft" ).trigger( "afterOpen.attr_xdsoft" )
			}, j.data( "options", C ).on( "touchstart mousedown.attr_xdsoft", function ( e ) {
				return e.stopPropagation(), e.preventDefault(), G.hide(), B.hide(), ! 1
			} ), E.append( R ), E.attr_xdsoftScroller( C ), j.on( "afterOpen.attr_xdsoft", function () {
				E.attr_xdsoftScroller( C )
				...
				t.now = function ( e ) {
					...
					"string" == typeof e ? t.currentTime = t.strToDateTime( e ) : t.isValidDate( e ) ? t.currentTime = e : e || a || ! C.allowBlank || C.inline ? t.currentTime = t.now() : t.currentTime = null, j.trigger( "xchange.attr_xdsoft" )
				}, t.empty = function () {
					t.currentTime = null
					...
					), t.currentTime.setDate( Math.min( new Date( t.currentTime.getFullYear(), a + 1, 0 ).getDate(), t.currentTime.getDate() ) ), t.currentTime.setMonth( a ), C.onChangeMonth && e.isFunction( C.onChangeMonth ) && C.onChangeMonth.call( j, A.currentTime, j.data( "input" ) ), j.trigger( "xchange.attr_xdsoft" ), a
				...
				e.preventDefault(), j.data( "changed", ! 0 ), A.setCurrentTime( i() ), a.val( A.str() ), j.trigger( "close.attr_xdsoft" )
			} ), I.find( ".attr_xdsoft_today_button" ).on( "touchend mousedown.attr_xdsoft", function () {
				j.data( "changed", ! 0 ), A.setCurrentTime( 0, ! 0 ), j.trigger( "afterOpen.attr_xdsoft" )
			} ).on( "dblclick.attr_xdsoft", function () {
				...
				r = new Date( r.getFullYear(), r.getMonth(), r.getDate() ), e = A.strToDate( C.minDate ), r < (
					e = new Date( e.getFullYear(), e.getMonth(), e.getDate() )
					                                                                                          ...
					                                                                                          a.val( A.str() ), a.trigger( "change" ), j.trigger( "close.attr_xdsoft" )
				                                                                                          )
				                                                                                          )
			} ), I.find( ".attr_xdsoft_prev,.attr_xdsoft_next" ).on( "touchend mousedown.attr_xdsoft", function () {
				...
				}( 500 ), e( [C.ownerDocument.body, C.contentWindow] ).on( "touchend mouseup.attr_xdsoft", function t() {
					clearTimeout( a ), r = ! 0, e( [
						C.ownerDocument.body,
						C.contentWindow
					] ).off( "touchend mouseup.attr_xdsoft", t )
				} )
			} ), L.find( ".attr_xdsoft_prev,.attr_xdsoft_next" ).on( "touchend mousedown.attr_xdsoft", function () {
				...
				! function e( o ) {
					...
					t.hasClass( C.next ) && s - i - C.timeHeightInTimePicker >= u ? R.css( "marginTop", "-" + (
						...
						u - C.timeHeightInTimePicker
					) + "px" ), E.trigger( "scroll_element.attr_xdsoft_scroller", [
			...
			} ), u = 0, j.on( "xchange.attr_xdsoft", function ( t ) {
				clearTimeout( u ), u = setTimeout( function () {
					...
					for (
						...
						T = [], D += 1, s = p.getDay(), u = p.getDate(), d = p.getFullYear(), l = p.getMonth(), f = A.getWeekOfYear( p ), h = "", T.push( "attr_xdsoft_date" ), c = C.beforeShowDay && e.isFunction( C.beforeShowDay.call ) ? C.beforeShowDay.call( j, p ) : null, C.allowDateRe && "[object RegExp]" === Object.prototype.toString.call( C.allowDateRe ) && (
							C.allowDateRe.test( r.formatDate( p, C.formatDate ) ) || T.push( "attr_xdsoft_disabled" )
						), C.allowDates && C.allowDates.length > 0 && - 1 === C.allowDates.indexOf( r.formatDate( p, C.formatDate ) ) && T.push( "attr_xdsoft_disabled" );
						var O = 31 * (
						        12 * p.getFullYear() + p.getMonth()
						) + p.getDate();
						(
							! 1 !== y && p > y || ! 1 !== k && p < k || ! 1 !== b && p < b || ! 1 !== x && O > w || c && ! 1 === c[0]
						) && T.push( "attr_xdsoft_disabled" ), - 1 !== C.disabledDates.indexOf( r.formatDate( p, C.formatDate ) ) && T.push( "attr_xdsoft_disabled" ), - 1 !== C.disabledWeekDays.indexOf( s ) && T.push( "attr_xdsoft_disabled" ), a.is( "[disabled]" ) && T.push( "attr_xdsoft_disabled" ), c && "" !== c[1] && T.push( c[1] ), A.currentTime.getMonth() !== l && T.push( "attr_xdsoft_other_month" ), (
							                                                                                                                                                                                                                                                                                                                                                                                       C.defaultSelect || j.data( "changed" )
						                                                                                                                                                                                                                                                                                                                                                                                       ) && r.formatDate( A.currentTime, C.formatDate ) === r.formatDate( p, C.formatDate ) && T.push( "attr_xdsoft_current" ), r.formatDate( v, C.formatDate ) === r.formatDate( p, C.formatDate ) && T.push( "attr_xdsoft_today" ), 0 !== p.getDay() && 6 !== p.getDay() && - 1 === C.weekends.indexOf( r.formatDate( p, C.formatDate ) ) || T.push( "attr_xdsoft_weekend" ), void 0 !== C.highlightedDates[r.formatDate( p, C.formatDate )] && (
							i = C.highlightedDates[r.formatDate( p, C.formatDate )], T.push( void 0 === i.style ? "attr_xdsoft_highlighted_default" : i.style ), h = void 0 === i.desc ? "" : i.desc
						), C.beforeShowDay && e.isFunction( C.beforeShowDay ) && T.push( C.beforeShowDay( p ) ), S && (
							g += "<tr>", S = ! 1, C.weeks && (
							                                                                                         g += "<th>" + f + "</th>"
						                                                                                         )
						), g += '<td data-date="' + u + '" data-month="' + l + '" data-year="' + d + '" class="attr_xdsoft_date attr_xdsoft_day_of_week' + p.getDay() + " " + T.join( " " ) + '" title="' + h + '"><div>' + u + "</div></td>", p.getDay() === C.dayOfWeekStartPrev && (
							g += "</tr>", S = ! 0
						), p.setDate( u + 1 )
					}
					g += "</tbody></table>", N.html( g ), I.find( ".attr_xdsoft_label span" ).eq( 0 ).text( C.i18n[o].months[A.currentTime.getMonth()] ), I.find( ".attr_xdsoft_label span" ).eq( 1 ).text( A.currentTime.getFullYear() + C.yearOffset ), M = "", l = "";
					var W = 0;
					if ( ! 1 !== C.minTime ) {
					...
					if ( m = function ( t, n ) {
						...
						(
							...
							o = new Date( A.currentTime )
							                                                                                                                                                ...
							                                                                                                                                                C.defaultSelect || j.data( "changed" ) ? T.push( "attr_xdsoft_current" ) : C.initTime && T.push( "attr_xdsoft_init_time" )
						                                                                                                                                                ), parseInt( v.getHours(), 10 ) === parseInt( t, 10 ) && parseInt( v.getMinutes(), 10 ) === parseInt( n, 10 ) && T.push( "attr_xdsoft_today" ), M += '<div class="attr_xdsoft_time ' + T.join( " " ) + '" data-hour="' + t + '" data-minute="' + n + '">' + r.formatDate( i, C.formatTime ) + "</div>"
					...
					for ( R.html( M ), n = "", D = parseInt( C.yearStart, 10 ); D <= parseInt( C.yearEnd, 10 ); D += 1 ) {
						n += '<div class="attr_xdsoft_option ' + (
							A.currentTime.getFullYear() === D ? "attr_xdsoft_current" : ""
						) + '" data-value="' + D + '">' + (
						     D + C.yearOffset
						     ) + "</div>";
					}
					for ( G.children().eq( 0 ).html( n ), D = parseInt( C.monthStart, 10 ), n = ""; D <= parseInt( C.monthEnd, 10 ); D += 1 ) {
						n += '<div class="attr_xdsoft_option ' + (
							A.currentTime.getMonth() === D ? "attr_xdsoft_current" : ""
						) + '" data-value="' + D + '">' + C.i18n[o].months[D] + "</div>";
					}
					B.children().eq( 0 ).html( n ), e( j ).trigger( "generate.attr_xdsoft" )
				}, 10 ), t.stopPropagation()
			} ).on( "afterOpen.attr_xdsoft", function () {
				if ( C.timepicker ) {
					var e, t, a, r;
					R.find( ".attr_xdsoft_current" ).length ? e = ".attr_xdsoft_current" : R.find( ".attr_xdsoft_init_time" ).length && (
						e = ".attr_xdsoft_init_time"
					), e ? (
						t = E[0].clientHeight, (
							                       a = R[0].offsetHeight
						                       ) - t < (
							                       ...
							                       r = a - t
						                       ), E.trigger( "scroll_element.attr_xdsoft_scroller", [
							parseInt( r, 10 ) / (
								a - t
							)
						] )
					) : E.trigger( "scroll_element.attr_xdsoft_scroller", [0] )
				}
			} ), d = 0, N.on( "touchend click.attr_xdsoft", "td", function ( t ) {
				t.stopPropagation(), d += 1;
				var r = e( this ), n = A.currentTime;
				if ( void 0 !== n && null !== n || (
					A.currentTime = A.now(), n = A.currentTime
				), r.hasClass( "attr_xdsoft_disabled" ) ) {
					return ! 1;
				}
				n.setDate( 1 ), n.setFullYear( r.data( "year" ) ), n.setMonth( r.data( "month" ) ), n.setDate( r.data( "date" ) ), j.trigger( "select.attr_xdsoft", [n] ), a.val( A.str() ), C.onSelectDate && e.isFunction( C.onSelectDate ) && C.onSelectDate.call( j, A.currentTime, j.data( "input" ), t ), j.data( "changed", ! 0 ), j.trigger( "xchange.attr_xdsoft" ), j.trigger( "changedatetime.attr_xdsoft" ), (
					                                                                                                                                                                                                                                                                                                                                                                                                   d > 1 || ! 0 === C.closeOnDateSelect || ! 1 === C.closeOnDateSelect && ! C.timepicker
				                                                                                                                                                                                                                                                                                                                                                                                                   ) && ! C.inline && j.trigger( "close.attr_xdsoft" ), setTimeout( function () {
					d = 0
				}, 200 )
			} ), R.on( "touchstart", "div", function ( e ) {
				this.touchMoved = ! 1
			} ).on( "touchmove", "div", X ).on( "touchend click.attr_xdsoft", "div", function ( t ) {
				if ( ! this.touchMoved ) {
					t.stopPropagation();
					var a = e( this ), r = A.currentTime;
					if ( void 0 !== r && null !== r || (
						A.currentTime = A.now(), r = A.currentTime
					), a.hasClass( "attr_xdsoft_disabled" ) ) {
						return ! 1;
					}
					r.setHours( a.data( "hour" ) ), r.setMinutes( a.data( "minute" ) ), j.trigger( "select.attr_xdsoft", [r] ), j.data( "input" ).val( A.str() ), C.onSelectTime && e.isFunction( C.onSelectTime ) && C.onSelectTime.call( j, A.currentTime, j.data( "input" ), t ), j.data( "changed", ! 0 ), j.trigger( "xchange.attr_xdsoft" ), j.trigger( "changedatetime.attr_xdsoft" ), ! 0 !== C.inline && ! 0 === C.closeOnTimeSelect && j.trigger( "close.attr_xdsoft" )
				}
			} ), z.on( "mousewheel.attr_xdsoft", function ( e ) {
				return ! C.scrollMonth || (
					e.deltaY < 0 ? A.nextMonth() : A.prevMonth(), ! 1
				)
			} ), a.on( "mousewheel.attr_xdsoft", function ( e ) {
				return ! C.scrollInput || (
					! C.datepicker && C.timepicker ? (
						(
							P = R.find( ".attr_xdsoft_current" ).length ? R.find( ".attr_xdsoft_current" ).eq( 0 ).index() : 0
						...
						z.trigger( e, [
							...
							e.deltaX,
							e.deltaY
						] ), a.val && a.val( A.str() ), j.trigger( "changedatetime.attr_xdsoft" ), ! 1
					) : void 0
				)
			} ), j.on( "changedatetime.attr_xdsoft", function ( t ) {
				if ( C.onChangeDateTime && e.isFunction( C.onChangeDateTime ) ) {
					var a = j.data( "input" );
					C.onChangeDateTime.call( j, A.currentTime, a, t ), delete C.value, a.trigger( "change" )
				}
			} ).on( "generate.attr_xdsoft", function () {
				C.onGenerate && e.isFunction( C.onGenerate ) && C.onGenerate.call( j, A.currentTime, j.data( "input" ) ), U && (
					j.trigger( "afterOpen.attr_xdsoft" ), U = ! 1
				)
			} ).on( "click.attr_xdsoft", function ( e ) {
				e.stopPropagation()
			} ), P = 0, H = function ( e, t ) {
				do {
					if ( ! (
			...
			}, j.on( "open.attr_xdsoft", function ( t ) {
				var a = ! 0;
				C.onShow && e.isFunction( C.onShow ) && (
					a = C.onShow.call( j, A.currentTime, j.data( "input" ), t )
				), ! 1 !== a && (
					j.show(), Y(), e( C.contentWindow ).off( "resize.attr_xdsoft", Y ).on( "resize.attr_xdsoft", Y ), C.closeOnWithoutClick && e( [
						C.ownerDocument.body,
						C.contentWindow
					] ).on( "touchstart mousedown.attr_xdsoft", function t() {
						j.trigger( "close.attr_xdsoft" ), e( [
							C.ownerDocument.body,
							C.contentWindow
						] ).off( "touchstart mousedown.attr_xdsoft", t )
					} )
				)
			} ).on( "close.attr_xdsoft", function ( t ) {
				var a = ! 0;
				I.find( ".attr_xdsoft_month,.attr_xdsoft_year" ).find( ".attr_xdsoft_select" ).hide(), C.onClose && e.isFunction( C.onClose ) && (
					a = C.onClose.call( j, A.currentTime, j.data( "input" ), t )
				), ! 1 === a || C.opened || C.inline || j.hide(), t.stopPropagation()
			} ).on( "toggle.attr_xdsoft", function () {
				j.is( ":visible" ) ? j.trigger( "close.attr_xdsoft" ) : j.trigger( "open.attr_xdsoft" )
			} ).data( "input", a ), q = 0, j.data( "attr_xdsoft_datetime", A ), j.setOptions( C ), A.setCurrentTime( i() ), a.data( "attr_xdsoft_datetimepicker", j ).on( "open.attr_xdsoft focusin.attr_xdsoft mousedown.attr_xdsoft touchstart", function () {
				a.is( ":disabled" ) || a.data( "attr_xdsoft_datetimepicker" ).is( ":visible" ) && C.closeOnInputClick || C.openOnFocus && (
					clearTimeout( q ), q = setTimeout( function () {
						a.is( ":disabled" ) || (
							U = ! 0, A.setCurrentTime( i(), ! 0 ), C.mask && s( C ), j.trigger( "open.attr_xdsoft" )
						)
					}, 100 )
				)
			} ).on( "keydown.attr_xdsoft", function ( t ) {
				var a, r = t.which;
				return - 1 !== [p].indexOf( r ) && C.enterLikeTab ? (
					a = e( "input:visible,textarea:visible,button:visible,a:visible" ), j.trigger( "close.attr_xdsoft" ), a.eq( a.index( this ) + 1 ).focus(), ! 1
				) : - 1 !== [T].indexOf( r ) ? (
					j.trigger( "close.attr_xdsoft" ), ! 0
				) : void 0
			} ).on( "blur.attr_xdsoft", function () {
				j.trigger( "close.attr_xdsoft" )
			} )
		}, u = function ( t ) {
			var a = t.data( "attr_xdsoft_datetimepicker" );
			a && (
				a.data( "attr_xdsoft_datetime", null ), a.remove(), t.data( "attr_xdsoft_datetimepicker", null ).off( ".attr_xdsoft" ), e( C.contentWindow ).off( "resize.attr_xdsoft" ), e( [
					C.contentWindow,
					C.ownerDocument.body
				] ).off( "mousedown.attr_xdsoft touchstart" ), t.unmousewheel && t.unmousewheel()
			)
		}, e( C.ownerDocument ).off( "keydown.attr_xdsoftctrl keyup.attr_xdsoftctrl" ).on( "keydown.attr_xdsoftctrl", function ( e ) {
			e.keyCode === h && (
				F = ! 0
			)
		} ).on( "keyup.attr_xdsoftctrl", function ( e ) {
			e.keyCode === h && (
				F = ! 1
			)
		} ), this.each( function () {
			var t = e( this ).data( "attr_xdsoft_datetimepicker" );
			if ( t ) {
				if ( "string" === e.type( n ) ) {
					switch ( n ) {
						case"show":
							e( this ).select().focus(), t.trigger( "open.attr_xdsoft" );
							break;
						case"hide":
							t.trigger( "close.attr_xdsoft" );
							break;
						case"toggle":
							t.trigger( "toggle.attr_xdsoft" );
							break;
						case"destroy":
							u( e( this ) );
							break;
						case"reset":
							this.value = this.defaultValue, this.value && t.data( "attr_xdsoft_datetime" ).isValidDate( r.parseDate( this.value, C.format ) ) || t.data( "changed", ! 1 ), t.data( "attr_xdsoft_datetime" ).setCurrentTime( this.value );
							break;
						case"validate":
							t.data( "input" ).trigger( "blur.attr_xdsoft" );
							break;
						default:
	...
	}, e.fn.attrDatetimepicker.defaults = a
};
! function ( e ) {
